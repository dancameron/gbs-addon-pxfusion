...
class Group_Buying_PxFusion extends Group_Buying_Credit_Card_Processors {
	
	const API_ENDPOINT_SANDBOX = 'https://secure.pxfusion.com/interfaces/a.net.test';
	const API_ENDPOINT_LIVE = 'https://secure.pxfusion.com/gateway/transact.dll';
	...
	private function post_data( Group_Buying_Checkouts $checkout, Group_Buying_Purchase $purchase ) {
		...
		$NVP_Data = apply_filters('gb_pxfusion_nvp_data', $NVP_Data); 
